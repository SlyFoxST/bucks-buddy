...
get_header();?>
<div class="layout-page-apll relative">
	...
	<div class="wrapper-silver">
		<div class="">
			<header class="header-aplic header-wrap-s header-scloll-a" id="section-application">
		...
		<section class="section-projects  container-page none2">
			<div class="fp-table" >
...
<div class="section-footer fuxcija p-footer">
